		...
		<div class="main-panel">
			<div class="content">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
						<form action="{{ route('admin.packedDateSearch') }}" method="GET" class="date-form">
										<div class="lab-date">
									<label>From</label>
						  ...
						  <a href="{{ route('admin.exportPackedBill',[
						            'date1'=>request('date1'),
						            'date2'=>request('date2')
						        ]) }}"
...
<div class="lab-date Import">
    <form action="{{ route('admin.importPackedBill') }}" method="POST" enctype="multipart/form-data">
        @csrf
