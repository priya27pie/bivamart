			...
			<div class="content">
				<div class="container-fluid">
					<div class="page-header">
						<h4 class="page-title">All Shipped Bill</h4>
...
<div class="lab-date Import">
    <form action="{{ route('admin.importShippedBill') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
<a href="{{ url('bill/'.$data->order_id)}}" target="_blank" class="btn btn-xs btn-info">Bill</a>
		...
		<button
    type="button"
    class="btn btn-xs btn-info ship-date-btn"
    data-toggle="modal"
    data-target="#ship-dateModal"
    data-id="{{ $data->id }}"
