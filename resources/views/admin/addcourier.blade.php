...
<div class="card">
	<div class="card-header">
		<div class="card-title">Add Courier</div>
	</div>
	@if ($errors->any())
...
@endif
 @if ($message = Session::get('error'))
   ...
   @endif
 	<form method="post" id="exampleValidation" action="{{route('submit.addcourier_data')}}" data-toggle="validator" enctype="multipart/form-data" > 
{{csrf_field()}}
		<div class="card-body">
