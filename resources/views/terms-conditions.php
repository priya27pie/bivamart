...
<div class="inner-banner">
  ...
  <p  data-aos="zoom-in" style="transition:all 1500ms ease-in-out;"> Terms & Conditions</p>
   <div class="particle-network-animation"></div>
  <div class="container">
    <!--<ul>-->
    <!--  <li><a href="terms-conditions.php" class="active">Terms & Conditions</a></li> |-->
...
<div class="terms">
    ...
    <div class="title-home" data-aos="fade-down" style="transition:all 1300ms ease-in-out;">
        <h2>Terms & Conditions <span> bivamart.com</span></h2>
    </div>
