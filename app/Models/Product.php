...
class Product extends Model
{
    ...
    protected $fillable = [
        'category','id','title','author','series','language','publisher','no_of_pages','binding','edition','illustrations','isbn','price','discounted_price','discount','description','specification','product_id','published_on','trending','latest','min_age','max_age','tags','weight','special_tag','tagcolor','age'
      ];  
